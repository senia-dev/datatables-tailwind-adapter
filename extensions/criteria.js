export function insertCriteria(elements) {
    return {
        ...
        dropDown: `dtsb-dropDown ${elements.forms.select} disabled:${elements.forms.disabled.split(' ').join(' disabled:')} h-full`,
        greyscale: ``,
        ...
        select: `dtsb-select ${elements.forms.select} disabled:${elements.forms.disabled.split(' ').join(' disabled:')} h-full`,
        value: `dtsb-value`,
